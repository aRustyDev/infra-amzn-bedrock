...
output "bedrock_runtime_endpoint_url" {
  ...
  value       = "https://bedrock-runtime.${local.region}.amazonaws.com"
}

output "vpc_endpoint_dns_names" {
  description = "DNS names for VPC endpoints"
  value = {
    runtime = aws_vpc_endpoint.bedrock_runtime.dns_entry
    control = aws_vpc_endpoint.bedrock_control.dns_entry
  }
}
...
output "cloudwatch_log_groups" {
  ...
  value = {
    ...
    vpc_flows = aws_cloudwatch_log_group.vpc_flow_logs.name
  }
}
...
output "cloudwatch_dashboard_url" {
  ...
  value       = "https://${local.region}.console.aws.amazon.com/cloudwatch/home?region=${local.region}#dashboards:name=${aws_cloudwatch_dashboard.bedrock_dashboard.dashboard_name}"
}
